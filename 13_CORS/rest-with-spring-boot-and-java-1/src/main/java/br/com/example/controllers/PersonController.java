...
public class PersonController {
	...
	@CrossOrigin(origins = {"http://localhost:8080", "https://eurudio.com.br"})
	...
	@Operation(summary = "Adds new a person", description = "Adds new a person by passing a JSON, XML or YML representation of the person",
	tags = {"People"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = PersonVO.class))), 	
