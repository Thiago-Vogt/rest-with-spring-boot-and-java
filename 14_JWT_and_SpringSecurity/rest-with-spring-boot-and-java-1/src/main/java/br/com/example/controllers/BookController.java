...
public class BookController {
	...
	@Operation(summary = "Adds new a book", description = "Adds new a book by passing a JSON, XML or YML representation of the book",
	tags = {"Book"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = BookVO.class))), 	
	...
	@Operation(summary = "Updates a book", description = "Updates a book by passing a JSON, XML or YML representation of the book",
	tags = {"Book"},
	responses = {
	...
	@Operation(summary = "Deletes a book", description = "Deletes a book by passing a JSON, XML or YML representation of the book",
	tags = {"Book"},
	responses = {
		@ApiResponse(description = "No content", responseCode = "204", content = @Content), 	
		@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
